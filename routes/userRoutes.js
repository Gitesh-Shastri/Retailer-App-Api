        ...
        if (user.length > 0) {
          ...
          Code.find()
            ...
            .then((doc) => {
              ...
              +"<tr ><td style=\"border: 1px solid #ddd;padding: 8px;align:center\">Salesman Email</td><td style=\"border: 1px solid #ddd;padding: 8px;align:center\">"+req.body.pharma_name+"</td></tr>"+
